          ...
          Column(
            children: [
              AnimatedContainer(
                ...
                height: 28.r,
                decoration: BoxDecoration(
                  color: isReached ? color : AppColors.surfaceWhite,
              ...
              if (!isLast)
                Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: stage.isDone ? color : AppColors.borderGrey.withOpacity(0.5),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(metric.icon, size: 16.r, color: metric.color),
          SizedBox(width: 8.w),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
