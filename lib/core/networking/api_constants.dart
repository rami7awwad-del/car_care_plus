class ApiConstants {
  ...
  // static const String baseUrl = 'http://192.168.137.56:8000/api/';
...
static String showBooking(int id) => 'bookings/$id';
  ...
  // ملاحظة: هذان المساران لا يستخدمان المغلّف العام للاستجابة
  static const String aiDiagnose = 'ai/diagnose';
  static const String aiApplyService = 'ai/apply-service';
